...
- `kernel-2d/editor/shell/floating.ts` — where a small floating card sits when it is opened at a spot in a panel: below the press, flipped above it, clamped last (U39.8). Shared by the entity window and the new-file menu (U45).
