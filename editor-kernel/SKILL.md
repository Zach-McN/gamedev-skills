...
### D29: Links are opaque to this service everywhere, so its containment checks stay lexical — resolving is only for checks that compare across namespaces
